...
/* particlesJS enable uncoment - yuo can setup js/particles.json */
...
function validateText(nameField){
    var reg = /^[A-Za-z0-9][A-Za-z0-9 -żźćńółęśŻŹĆŃÓŁĘŚ]*$/i;     
       if (reg.test(nameField.value) == false)
        {
            //alert('Podaj Imię');
            document.example.text.value = "Wpisz wiadomość";
...
function validateName(nameField){
    var reg = /^[A-Za-z0-9][A-Za-z0-9 -żźćńółęśŻŹĆŃÓŁĘŚ]*$/i;     
       if (reg.test(nameField.value) == false)
        {
            //alert('Podaj Imię');
            document.example.name.value = "Podaj swoje imię";
